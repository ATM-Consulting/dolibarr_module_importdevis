 ...
 */
class importdevisbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "importdevis@importdevis";
    public $boxlabel;
    public $depends = array("importdevis");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/importdevis/class/importdevis.class.php";
